/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9fe52d4271ce93ddd10e3af82d63a172)
// Runtime types generated with workerd@1.20260107.1 2026-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "WorkspaceAPI" | "MyYServer";
	}
	interface Env {
		VITE_URL: string;
		MyYServer: DurableObjectNamespace<import("./worker/index").MyYServer>;
		WORKSPACE_API: DurableObjectNamespace<import("./worker/index").WorkspaceAPI>;
		BetterAuthDB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_URL">> {}
}
